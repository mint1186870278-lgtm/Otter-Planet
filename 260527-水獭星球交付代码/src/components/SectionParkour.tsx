import React, { useEffect, useState, useRef, Component, type ReactNode, useCallback } from 'react';
...
const PLAYER_SPEED = 13 * ACTOR_SCALE;
const DIRECTION_TO_KEY: Record<TutorialDirection, 'ArrowLeft' | 'ArrowRight' | 'ArrowUp' | 'ArrowDown'> = {
  left: 'ArrowLeft',
  right: 'ArrowRight',
  up: 'ArrowUp',
  down: 'ArrowDown',
};
const KEY_TO_MOVEMENT_KEY: Record<string, 'ArrowLeft' | 'ArrowRight' | 'ArrowUp' | 'ArrowDown'> = {
  ArrowLeft: 'ArrowLeft',
...
const TUTORIAL_STEP_MOVE_MS = 120;
const STAR_GUIDE_REACH_RADIUS = 2.4;
...
const NPC_PORTRAIT = { height: '78vh', top: '2%', right: 'calc(18% + 5px)' };

function computeVelocity(held: Set<string>, yaw: number, frozen: boolean): Vec2 {
...
type FeedbackItem = { id: number; kind: 'star' | 'box'; text: string };

// 三个 NPC 的 System Prompt（索引 0/1/2 对应 NPC1/2/3）
const NPC_SYSTEM_PROMPTS: readonly string[] = [
  // NPC1 啄木鸟（意图判断）
